...
function StudyPlannerPage({ profile, currentUser }) {
  ...
  return (
    <main className="study-planner-page">
      ...
      <button type="button" className="planner-mobile-fab" aria-label="Create event" onClick={() => openCreateModal(new Date())}><span className="material-symbols-outlined text-white">add</span></button>
