...
function FlashCardsWorkspace({ profile, currentUser }) {
  ...
  return <main className="p-gutter md:p-margin-desktop space-y-xl flash-page">
    ...
    {isGeneratingCards && <div className="flash-generation-banner" role="status" aria-live="polite"><span className="material-symbols-outlined">auto_awesome</span><div><strong>New cards are generating</strong><small>You can keep using Flash Cards while Academent builds and saves them.</small></div></div>}
