  ...
  return (
    <div className="min-h-screen w-full flex items-stretch overflow-hidden bg-background font-body-md animate-fade-in">
      ...
      <section
        ...
        className="hidden md:flex md:w-[50%] relative overflow-hidden flex-col justify-between p-xxl bg-gradient-to-tr from-[#4d2b8c] to-[#85409d]"
      >
        ...
        <div className="relative z-10 max-w-xl my-auto">
          ...
          <div className="relative flex justify-center">
            <div
              style={parallaxStyle}
              className="relative rounded-2xl overflow-hidden aspect-[4/3] w-[100%] z-10 border border-white/10 shadow-2xl floating-anim"
            >
              <img
      ...
      <section className="w-full md:w-[50%] bg-surface flex flex-col items-center justify-center p-gutter md:p-xxl overflow-y-auto">
        ...
        <div className="w-full max-w-[420px] animate-fade-in-up">
          ...
          <form id="resetForm" onSubmit={handleSubmit} className="space-y-lg">
            ...
            >
              {status === 'submitting' ? (
                <LoadingEffect variant="inline" title="Sending link" />
              ) : status === 'success' ? (
                <>
